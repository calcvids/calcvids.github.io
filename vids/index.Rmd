...
1. [Ximera introduction](https://ximera.osu.edu/fall18calcvids/intro/intro)
...
1. Continuity - Coming soon
1. [Differentiability and Local Linearity](./locallin)
1. [Limit Definition of Derivative](./limitdef)
1. Using the Limit Definition of Derivative - Coming soon
1. Interpreting Derivatives - Coming soon
1. [Secant Lines and Tangent Lines](./secanttangent)
1. Graphing Derivatives - Coming soon <!-- [Graphing Derivatives](./graphingderiv) -->
1. [Basic Derivative Rules](./basicderivrules)
1. [Product Rule](./product)
1. Quotient Rule - Coming soon
1. [Chain Rule](./chain)
1. Mean Value Theorem - Coming soon
1. Extreme Value Theorem - Coming soon
...
1. [End of semester survey](https://ximera.osu.edu/calcvidstest/survey/survey)
