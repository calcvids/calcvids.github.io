...
1. [Name/instructor identificaion (only for google accounts)](https://ximera.osu.edu/calcvids2019/google/login/google/page)
...
1. Limit at a Point - in preparparation
1. Limit Laws - in preparation
1. Limit at Infinity - in preparation
...
1. [Related Rates](./relrates)
1. [Implicit Differentiation](./implicit)
1. [Optimization Intro](./optintro)
1. [Optimization Modeling](./optmodel2)
1. [Riemann Sums Introduction](./rsintro)
1. [Riemann Sums Notation](./rsnotation)
1. [Definite Integrals](./defint2)
1. [Antiderivatives](./antideriv)
1. [FTOC 1 - Integrals are Antiderivatives](./ftoc1)
1. [FTOC 2 - variable in bounds](./ftoc2)
1. [U-Substitution](./usub)
