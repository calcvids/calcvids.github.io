...
- **Using google/twitter/github logins**
  - Students will use their own login. If you provide a link to calcvids.org/vids on your LMS, the student may already be logged in. If they are not, they should go to the top right corner of the screen and click the log in button. They should then log in using whichever account they would like.
  - After this, they should go to the login page (video set 1) where they can enter their name and select their instructor. They can then watch any video set, and results will be added to your spreadsheets.
...
- **Common Information**
  - The research team will create a folder on Google Drive for each instructor. This folder will contain a spreadsheet for each Ximera set students complete showing the date/time each student watched the videos and their score on the post-video questions. This folder will be updated daily at 11pm Eastern US time. To access the folder, instructors should send their Google (or Google-connected) email address to Matt Thomas (<mthomas7@ithaca.edu>).
