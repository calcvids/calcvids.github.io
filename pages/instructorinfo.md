...
Using Ximera
------------
The instructions for using ximera will depend on whether you are going to have your students use their own logins (google, twitter, or github) or use usernames and passwords generated by us. Using students own logins can either be through your school if your school uses google, or can be through their own accounts.

- **Using a Google-enabled login**
  - If your institution has a Google-enabled account, you can elect for your student to log in to Ximera with their institutional username and password; they can enter this information in Ximera by clicking sign in at the top right corner of the screen, then selecting google login, and entering their school credentials. If you provide a link to an assignment on calcvids.org/vids via your LMS (e.g., Canvas), the students may be automatically logged in to Ximera.
  ...
  - In order to use this option, we need to include your name on the instructor list by January 5th, 2020.

- **Using our usernames and passwords**
  - If your institution doesn't use Google-enabled logins--or if you haven't told us you'd like to use Google logins by January 5th--your students will need to log in to Ximera with a username and password we provide.
  - Send us your class roster, and we will send you back a username and password for each student.
  - By clicking the log in button at the top right corner of the screen, the student can enter their username and password, and their progress will be added to your spreadsheets.
...
---------------
 ...
 - **Students**
   - To log in to Ximera, each student will receive a user name and password from their instructor. Alternatively, if their institution uses a Google-enabled login and their instructor tells them to do so, students can use their institutional username and password to log in to Ximera.
   ...
   - If a student is logging in to Ximera using an institutional username/password and it is their first time logging in on a particular device or browser, they will need to visit Video Set 1 to enter their name and instructor.
   - After completing the work on a page--including watching a video--either click the blue "Save" at the top of the screen or wait for the button to switch to "Saved!"
